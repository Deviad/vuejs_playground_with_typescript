...
import {ArrayPropsDefinition, DefaultProps, PropsDefinition, RecordPropsDefinition} from "vue/types/options";


export default  (componentContext: any) => {
    
  const { props: {msg = ""} = {} } = componentContext;
  return (
    <div className='hello'>
      <h1>{msg}</h1>
      <p>
